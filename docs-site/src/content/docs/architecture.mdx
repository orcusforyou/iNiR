...
- Calls the unified Python color pipeline to generate colors
...
3. `generate_colors_material.py` generates Material You colors
...
7. GTK/Qt themes applied via rendered templates
