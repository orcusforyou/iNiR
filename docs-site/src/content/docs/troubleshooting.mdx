...
### Verify the iNiR Python environment is installed

```bash
~/.local/state/quickshell/.venv/bin/python3 -c "import materialyoucolor"
```

If that fails, install the Python dependencies again:
