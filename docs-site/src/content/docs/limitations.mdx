...
**Python color pipeline required for wallpaper colors**
- Wallpaper theming depends on the project Python venv
- `materialyoucolor` must be available in that environment
- Manual theme editing is possible but more tedious than presets
