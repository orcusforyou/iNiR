...
**Theming:** wallpaper-based Material You color extraction, 41 presets, terminal theme sync for foot/kitty/alacritty/wezterm/ghostty/konsole
...
- PipeWire, Python virtualenv support
